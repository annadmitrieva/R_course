...
```{r 1_3}
chisq.test(russian.tab)$expected
#          acc       loc
#  na 148.7124 103.28755
#  w  126.2876  87.71245

chisq.test(polish.tab)$exp
#           acc      loc
#  na 10.171429 78.82857
#  w   1.828571 14.17143
```

### 1.4 <?> Calculate effect size using odds ratio
```{r 1_4}
oddsratio(russian.tab)
#log odds ratios for  and  

#[1] 0.2602612

oddsratio(polish.tab)
#log odds ratios for  and  
